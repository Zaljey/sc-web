...
if (!isset($_SESSION['username']) || $_SESSION['usertype'] !== 'staff') {
    // Redirect to the login page if not logged in as staff
...
// Retrieve staff-specific data from the database
...
<head>
    ...
    <title>Reservation - The Signature Cuisine</title>
...
<body>
    ...
    <!-- Main Section -->
    <section>
        <h2>Welcome to Your Staff Dashboard, <?php echo $_SESSION['username']; ?>!</h2>
    ...
    <section class="contact">
            ...
            <ul>
                ...
                <li>Email: info@oSignatureCuisine.com</li>
            </ul>
